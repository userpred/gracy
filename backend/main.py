...
def run():
    ...
    raise NotImplementedError("Please use 'gracy-Staking-Api run'.")


@cli.command()
def prod_run():
    """Please use 'imfast prod-run'."""
    raise NotImplementedError("Please use 'gracy-Staking-Api prod-run'.")


@cli.command()
def test():
    """Run tests"""
    raise NotImplementedError("Please use 'gracy-Staking-Api test'.")
